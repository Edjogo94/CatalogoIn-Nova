  ...
  return (
    ...
    >
      <div className="relative aspect-[4/5] overflow-hidden bg-slate-50">
        ...
        <button onClick={handleWhatsApp} className="absolute bottom-5 right-5 bg-white text-slate-900 p-3 rounded-2xl shadow-xl opacity-0 group-hover:opacity-100 transition-opacity hover:bg-cyan-500 hover:text-white z-20">
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <div className="mt-auto flex justify-between items-end border-t border-slate-50 pt-4">
          <div className="flex flex-col">
            <span className="text-[8px] font-black text-cyan-600 uppercase tracking-widest mb-1">Detal</span>
            <span className="text-2xl font-black text-slate-900 tracking-tighter">{formatPrice(product.retailPrice)}</span>
          </div>
          <div className="flex flex-col items-end opacity-40">
            <span className="text-[7px] font-bold uppercase tracking-widest">Mayor</span>
