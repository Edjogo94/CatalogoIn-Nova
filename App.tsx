...
const DB_KEY = 'innova_full_db_v17';
        ...
        if (!fromCloud) {
           ...
           if (savedDB) {
             ...
             loadedProducts = RAW_PRODUCT_NAMES.map((name, index) => {
               ...
               if (name.includes("CINTA") || name.includes("CÁMARA") || name.includes("RELOJ") || name.includes("LAMPARA") || name.includes("MATEMÁTICAS") || name.includes("AMPLIFICADOR") || name.includes("LENTES")) cat = Category.TECH;
